...
public class CommentedInvoicesController {
    ...
    public void setPurchaseInvoiceController(PurchaseInvoiceController purchaseInvoiceController) {
    ...
    public void fillTable() {
        ...
        List<Map<String, Object>> invoices = db.SelectQuery("purchaseinvoices" , "InvoiceStatus" , "on hold");
