...
public class ReportAboutExpiredItemsinStrockController {
    ...
    public void RefreshButtonAction() {
        ...
        // Remove the rows where the item has not expired
        data.removeIf(row -> {
            String expiryDateString = row.get("ExpiryDate").toString();
